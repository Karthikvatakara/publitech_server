...
const instructorStatusChange_1 = __importDefault(require("../../database/mongodb/repositories/instructorStatusChange"));
exports.default = (userData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, instructorStatusChange_1.default)(userData);
    }
    catch (error) {
