...
const getEnrollmentByCourseIdController = (dependencies) => {
    const { useCases: { getEnrollmentByCourseIdUseCase } } = dependencies;
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { courseId, userId } = req.params;
            const enrollment = yield getEnrollmentByCourseIdUseCase(dependencies).execute(courseId, userId);
            if (!enrollment) {
                throw ErrorResponse_1.default.notFound("the enrollment not found");
            }
