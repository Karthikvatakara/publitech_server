...
const getExamResultByExamIdController = (dependencies) => {
    const { useCases: { fetchExamResultByExamIdUseCase } } = dependencies;
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { examId } = req.params;
            const assessmentRef = examId;
            const examresult = yield fetchExamResultByExamIdUseCase(assessmentRef);
        }
        catch (error) {
            next(error);
        }
