...
exports.isEnrollmenetExistController = void 0;
const ErrorResponse_1 = __importDefault(require("../../_lib/common/error/ErrorResponse"));
const isEnrollmenetExistController = (dependencies) => {
    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const enrollmentDetails = yield isEnrollmentExistUseCase(dependencies).execute(courseId, userId);
            if (!enrollmentDetails) {
                throw ErrorResponse_1.default.notFound("enrollment details not found");
            }
...
exports.isEnrollmenetExistController = isEnrollmenetExistController;
