...
const updateCourseController = (dependencies) => {
    const { useCases: { updateCourseUseCase } } = dependencies;
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { courseId } = req.params;
            const data = req.body;
            const updated = yield updateCourseUseCase(dependencies).execute(courseId, data);
            if (!updated) {
                throw ErrorResponse_1.default.internalError("Data not updated");
            }
