...
const createExamController = (dependencies) => {
    const { useCases: { createExamUseCase } } = dependencies;
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            console.log(req.body, "in the createexam controller");
            const data = req.body;
            const createExam = yield createExamUseCase(dependencies).execute(data);
            if (!createExam) {
                return ErrorResponse_1.default.internalError("exam not created succesfully");
            }
