...
exports.getExamResultByExamIdUseCase = void 0;
const getExamResultByExamIdUseCase = (dependencies) => {
    ...
    return {
        execute: (assessmentRef) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                return yield fetchExamResultById(assessmentRef);
            }
            catch (error) {
...
exports.getExamResultByExamIdUseCase = getExamResultByExamIdUseCase;
