...
const getAllCategoryUseCase = (dependencies) => {
    const { repositories: { getAllCategory } } = dependencies;
    return {
        execute: () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                return yield getAllCategory();
            }
            catch (error) {
                throw new Error((error === null || error === void 0 ? void 0 : error.message) || "error occured in getall category repository");
            }
        })
    };
};
