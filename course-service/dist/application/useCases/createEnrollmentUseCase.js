...
const createEnrollmentUseCase = (dependencies) => {
    const { repositories: { createEnrollment } } = dependencies;
    return {
        execute: (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                return yield createEnrollment(data);
            }
            catch (error) {
                throw new Error((error === null || error === void 0 ? void 0 : error.message) || "error is occured in create enrollment usecase");
            }
        })
    };
};
