...
const createCategoryUseCase = (dependencies) => {
    const { repositories: { createCategory } } = dependencies;
    return {
        execute: (data) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                return yield createCategory(data);
            }
            catch (error) {
                throw new Error((error === null || error === void 0 ? void 0 : error.message) || "error occured in the createcategoryusecase");
            }
        })
    };
};
