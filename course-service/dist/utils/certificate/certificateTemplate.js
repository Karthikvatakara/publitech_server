...
const CertificateTemplate = (doc, examResult) => {
    var _a;
    ...
    doc.fontSize(30)
        .font('Helvetica-Bold')
        .fillColor('#2980b9')
        .text(`${(_a = examResult === null || examResult === void 0 ? void 0 : examResult.userRef) === null || _a === void 0 ? void 0 : _a.username}`, 0, 220, { align: 'center' });
    doc.fontSize(20)
        .font('Helvetica')
        .fillColor('#34495e')
